...
//          indicatorColor: new Color.fromRGBO(19, 35, 63, 1),    //设置tab指示器颜色
          ...
          textTheme: new TextTheme(
              title: new TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.normal),
              subtitle: new TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.normal)),
          primaryTextTheme: new TextTheme(
              //设置文本样式
              title: new TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.bold)),
          tabBarTheme: new TabBarTheme(labelColor: Colors.black, unselectedLabelColor: Colors.grey)),
    );
  }
}
