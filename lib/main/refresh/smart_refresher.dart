...
import 'package:flutter_flowermusic/main/refresh/classic_indicator.dart';
import 'dart:math' as math;

import 'package:flutter_flowermusic/main/refresh/default_constants.dart';
import 'package:flutter_flowermusic/main/refresh/footer_indicator.dart';
import 'package:flutter_flowermusic/main/refresh/indicator_config.dart';
import 'package:flutter_flowermusic/main/refresh/indicator_wrap.dart';
import 'package:flutter_flowermusic/main/refresh/refresh_physics.dart';
  ...
  SmartRefresher({
    ...
    this.onOffsetChange,
        ...
        this.footerBuilder = footerBuilder ??
            ((BuildContext context, RefreshStatus mode) {
              return new FooterIndicator(mode: mode);
            }),
        super(key: key);
